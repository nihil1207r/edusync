...
export default function StudentPage() {
  ...
  return (
    <AppShell user={user} title={`Student dashboard — ${data.profile?.class ?? ""}`} tabs={TABS} activeTab={tab} onTabChange={setTab}>
